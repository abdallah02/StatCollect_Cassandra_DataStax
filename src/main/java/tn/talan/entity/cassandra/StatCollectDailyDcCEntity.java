...
@Table(name = "stat_collect_daily_dc", keyspace = "talankeyspace")
public class StatCollectDailyDcCEntity implements java.io.Serializable {
    @Column(name = "dc")
    @PartitionKey(0)
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        StatCollectDailyDcCEntity other = (StatCollectDailyDcCEntity) obj;
        if (dateCollect == null) {
    ...
    public String toString() {
        return "StatCollectDailyDcCEntity [dc=" + dc + ", yearmonthcollect=" + yearmonthcollect + ", dateCollect="
                + dateCollect + ", taskId=" + taskId + ", deviceCount=" + deviceCount + ", fullSuccessRate="
